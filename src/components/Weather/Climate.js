...
const Climate = (props) => {
    ...
    const {weather, main} = temperature;
    ...
    <Card>
        ...
        <CardBody>
          ...
          <CardSubtitle>{weather === undefined ? '' : weather[0].main}</CardSubtitle>
          <CardText>{button === true ? `${fahrenheitTemp}°F`: `${celsiusTemp}°Celsius`}. Feels like: {main !== undefined ? main.feels_like : ''} </CardText>
