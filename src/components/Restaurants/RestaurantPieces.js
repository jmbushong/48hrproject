...
const RestaurantPieces = (props) => {
    ...
    return(
        ...
        <CardBody>
          <CardTitle>Top Restaurants Near You</CardTitle>
          <CardSubtitle>Hungry?</CardSubtitle>
          <CardText>Having a hard time finding a place to eat. Look no further. Your present location currently has about 9 places to choose from. See below link!</CardText>
