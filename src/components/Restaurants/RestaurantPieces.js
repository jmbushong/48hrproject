        ...
        <div>
            <Card>
                ...
                <CardBody>
                    ...
                    <CardText className="restaurantPiecesCardText">
                        Having a hard time finding a place to eat. Look no further. Your present location currently has about 9 places to choose from. See below link!
                    </CardText>
